...
var (
	pattern_TurlService_NewURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "turl", "new"}, ""))

	pattern_TurlService_GetURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"t", "hash"}, ""))
)
